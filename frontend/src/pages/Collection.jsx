      ...
      <div className="collection-filters">
        ...
        <div className={`filter-box ${showFilter ? "" : "hidden"}`}>
          ...
          <div className="filter-options">
            {["Air-Jordans", "Air-Max", "Kicks","Sneakers","ZoomX","Sports"].map((cat) => (
              <label key={cat}>
        ...
        <div className={`filter-box ${showFilter ? "" : "hidden"}`}>
          ...
          <div className="filter-options">
            {["Highs","Lows","Mids","Sneakers","Sports","Casuals"].map((sub) => (
              <label key={sub}>
        ...
        <div className={`filter-box ${showFilter ? "" : "hidden"}`}>
          ...
          <div className="filter-options">
            {["Uk-7", "Uk-8", "Uk-9", "Uk-10", "Uk-11"].map((sub) => (
              <label key={sub}>
